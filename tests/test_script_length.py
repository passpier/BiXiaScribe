...
# byte-content update, not a stale guard. _ORIG_SCENE_WRITE further updated
# for the dialogue-npc-must-be-an-id prompt clause (crew/tasks.py), added
# to prevent the scene_writer from filling dialogue[].npc with an NPC's
# display name instead of its id -- see crew/normalize.py's
# normalize_scene_npc_ids docstring for the real run this fixes.
